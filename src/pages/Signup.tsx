      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <Input id="password" type={showPw ? "text" : "password"} placeholder="••••••••" autoComplete="new-password" className="pr-10" {...register("password")} />
        ...
        <div className="flex items-start gap-2">
          <Checkbox id="terms" checked={watch("terms")} onCheckedChange={(v) => setValue("terms", Boolean(v) as true, { shouldValidate: true })} className="mt-0.5" />
